...
def test_ransac_fundamental_matrix():
    np.random.seed(0)
    pic_a = single2im(load_image(f"{DATA_ROOT}/argoverse_log_273c1883/ring_front_center_315975640448534784.jpg"))
    scale_a = 0.5
    pic_b = single2im(load_image(f"{DATA_ROOT}/argoverse_log_273c1883/ring_front_center_315975643412234000.jpg"))
    scale_b = 0.5
    n_feat = 4e3
